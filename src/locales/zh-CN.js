export default {
  ...
  'menu.models.serving': '模型服务',
  'menu.jobs': '作业管理',
  'menu.jobs.list': '作业列表',
  'menu.storage': '中央存储',
  'menu.storage.filelist': '文件列表',
  'menu.storage.dataset': '数据集列表',
  'menu.graph': '图数据管理',
  'menu.graph.list': '项目列表',
  'menu.graph.jobs': '作业管理',
  'menu.graph.schema': '设计器',
  'menu.graph.mapper': '数据导入',
  'menu.graph.query': '数据查询',
  'menu.graph.explore': '数据探索',
  'menu.users': '用户管理',
