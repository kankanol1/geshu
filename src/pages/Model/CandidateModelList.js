...
@Form.create()
class CandidateModelList extends PureComponent {
  state = {
    modalVisible: false,
    selectedRows: [],
    expendForm: false,
          ...
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <Popconfirm title="确认发布吗?" onConfirm={() => this.handleMultiPublish()}>
                {selectedRows.length > 0 && <Button type="primary">批量发布</Button>}
              </Popconfirm>
...
export default CandidateModelList;
