...
import { queryDatasetData, queryDatasetHistogram } from '@/services/datapro/datasetAPI';
...
export default class DetailTable extends React.Component {
  ...
  fetchIfStillLoading = () => {
    ...
    const queryHistogram = queryDatasetHistogram;
    if (histgoramLoading) {
      queryHistogram({ id: datasetId }).then(response => {
  ...
  fetchData(state, instance) {
    ...
    const queryData = queryDatasetData;
