  ...
  render() {
    return (
      <div style={{ padding: '0', height: '100%', overflow: 'hidden', position: 'relative' }}>
        ...
        <div className={this.state.variableRange ? styles.searchBox : styles.searchBoxHide}>
          <GraphExploreForm
        ...
        <div
          className={
            this.state.variableRange ? styles.variableRangeBox : styles.variableRangeBoxHide
          }
        >
          <i
            className={this.state.variableRange ? styles.variableRange : styles.variableRangeHide}
