...
class GraphExploreForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      searchNodeList: [
  ...
  updateAttr(index, key, value, type) {
    if (type === 'node') {
      ...
      if (key === 'type') {
        ...
        searchListNodeNow[index].renderAttrs.nodeType =
          this.props.type2Label2Attrs.nodeType[value] || []; // eslint-disable-line
      } else if (key === 'attr') {
      ...
      if (key === 'type') {
        searchListLinkNow[index].renderAttrs.linkType =
          this.props.type2Label2Attrs.linkType[value] || []; // eslint-disable-line
        ...
        <Tabs defaultActiveKey="1" type="card" tabPosition="top">
          <TabPane tab="单点探索" key="1" style={{ background: '#fff' }}>
            <Tabs
              ...
              tabBarStyle={{ marginBottom: 0, paddingLeft: 75 }}
            >
              <TabPane tab="节点" key="1" style={{ height: '100%', overflow: 'hidden' }}>
                <a
                  ...
                  onClick={this.addAttr.bind({}, 'node')}
                >
                    ...
                    <div className={styles.typeBox} key={index}>
                      {item.type || item.attr || item.attrData ? (
                        ...
                        <a
                          ...
                          onClick={this.removeAttr.bind({}, index, 'node')}
                        >
                          <Icon type="close" />
                        </a>
                      )}
                        ...
                        <Col span={15}>
                          ...
                          >
                            {this.props.type2Labels.node.map(value => (
                              <Select.Option value={value} key={`label-${value}`}>
                                {value}
                              </Select.Option>
                            ))}
                          </Select>
                        ...
                        <Col span={15}>
                          ...
                          >
                            {this.state.searchNodeList[index].renderAttrs.node.map(value => (
                              <Select.Option value={value} key={`name-${value}`}>
                                {value}
                              </Select.Option>
                            ))}
                          </Select>
                      ...
                      <Row style={{ marginTop: 10, width: '100%', float: 'left' }}>
                        ...
                        <Col span={15}>
                          {this.state.searchNodeList[index].renderAttrs.nodeType[
                            this.state.searchNodeList[index].selectIndex
                          ] !== 'String' ? (
                            <div>
                              <Input
                ...
                <Row style={{ marginTop: 10, float: 'left', width: '100%' }}>
                  <Col span={7} style={{ marginLeft: 10, marginTop: 3 }}>
                    最大值
                  </Col>
                  <Col span={15}>
                    <Input
                ...
                <Button
                  type="primary"
                  icon="search"
                  style={{ width: '100%', marginTop: 10, marginBottom: 30, float: 'left' }}
                  onClick={this.searchData.bind({}, 'node')}
                >
                  搜索
                </Button>
              </TabPane>
              <TabPane tab="关系" key="2" style={{ height: '100%', overflowY: 'hidden' }}>
                <a
                  ...
                  onClick={this.addAttr.bind({}, 'link')}
                >
                  <Icon type="plus-circle" />
                  添加
                </a>
                    ...
                    <div className={styles.typeBox} key={index}>
                      {item.type || item.attr || item.attrData ? (
                        ...
                        <a
                          ...
                          onClick={this.removeAttr.bind({}, index, 'link')}
                        >
                          <Icon type="close" />
                        </a>
                      )}
                      ...
                      <Row style={{ marginTop: 10, width: '100%', float: 'left' }}>
                        ...
                        <Col span={15}>
                          {this.state.searchLinkList[index].renderAttrs.linkType[
                            this.state.searchLinkList[index].selectIndex
                          ] !== 'String' ? (
                            <div>
                              <Input
                                className={styles.attrTypeRange}
                ...
                <Button
                  ...
                  icon="search"
                  style={{ width: '100%', marginTop: 10, marginBottom: 30, float: 'left' }}
                  onClick={this.searchData.bind({}, 'link')}
                >
                  搜索
                </Button>
              </TabPane>
          ...
          <TabPane tab="路径搜索" key="2">
            ...
            >
              ...
              <Button
                type="primary"
                icon="search"
                style={{ width: '100%', marginTop: 10, marginBottom: 20, float: 'left' }}
                onClick={this.searchRouteData.bind({}, 'link')}
              >
                搜索
              </Button>
            </div>
...
export default GraphExploreForm;
