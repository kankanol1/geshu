...
class WorkspaceDataView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      showSider: true,
    ...
    return (
      <Layout style={{ padding: '0', height: '100%' }} theme="light">
        ...
        <Layout style={{ padding: '0', height: '100%' }} theme="light" className={styles.dataView}>
                        ...
                        <div className={styles.componentCell}>
                          ...
                          <span className={styles.smallIcons}>
                            <Tooltip title={item.hideSchema ? '展开schema信息' : '隐藏schema信息'}>
                              <Icon
                                type={item.hideSchema ? 'plus' : 'minus'}
                                onClick={() => this.toggleTableItemStatus(item)}
                              />
                            </Tooltip>
          ...
          <PersistTableForm {...parentMethods} modalVisible={modalVisible} />
        </Layout>
      </Layout>
    );
  }
...
export default WorkspaceDataView;
