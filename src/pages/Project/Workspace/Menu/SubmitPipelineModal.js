...
@connect(({ pipeline_submit }) => ({ pipeline_submit }))
class SubmitPipelineModal extends React.Component {
        ...
        footer={
          loading
            ...
            : [
              <Button
                key="back"
                onClick={() => this.handleSubmitPipelineModalCancel()}
                disabled={loading}
              >
                知道了
              </Button>,
                result.success ? (
                  <Button
                    ...
                    type="primary"
                    loading={loading}
                    onClick={() => this.handleSubmitPipelineModalOk()}
                  >
                    查看项目输出
                  </Button>
                ) : (
...
export default SubmitPipelineModal;
