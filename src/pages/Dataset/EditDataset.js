...
class EditDataset extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      type: 'CSV',
    ...
    return (
      <Form onSubmit={e => this.handleFormSubmit(e)} style={{ padding: '20px' }}>
        ...
        <div>
          <Button
            style={{ marginLeft: 20 }}
            onClick={() => this.props.dispatch(routerRedux.push('/storage/dataset/index'))}
          >
            &lt;&nbsp;返回
          </Button>
