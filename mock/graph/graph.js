...
export function getDataSources(req, res) {
  const fileList = [];
  for (let i = 0; i < 10; i++) {
    fileList.push({ id: `file${i}`, name: `file${i}.csv` });
  }
  const result = {
    success: true,
    data: fileList,
