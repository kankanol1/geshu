...
const allStatus = ['initialized', 'queued', 'started', 'canceled', 'finished', 'failed'];
  ...
  const result = [
    {
      ...
      projectName: null,
      properties: '{}',
      opIds: ['向量组装1535487929871', '分词1531527496608'],
    },
    {
      id: 2,
      projectId: 12,
      ...
      projectName: null,
      properties: '{}',
      opIds: ['文件读取1531527496607', 'Join1532467809093'],
    },
    {
      id: 3,
      projectId: 12,
      ...
      projectName: null,
      properties: '{}',
      opIds: ['分词15315274966', '分词1531527496608'],
    },
  ];
...
export default {
  ...
  'GET /api/jobs/newjobresultbypid': getNewPipelineJobByProjectId,
